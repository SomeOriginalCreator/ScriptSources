...
local entitySpeed = 1 --Speed of entity
...
entity.Figure.CFrame = CFrame.new(workspace.CurrentRooms[tostring(spawnRoom)].Door.Door.CFrame.Position)
entity.Parent = workspace
local cPart = entity.Figure
entity.Figure.Footsteps:Play()
entity.Figure.FootstepsFar:Play()
entity.SeekMusic.TimePosition = 0

--Start seek animations
