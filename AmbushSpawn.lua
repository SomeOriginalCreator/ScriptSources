...
local url = "https://github.com/SomeOriginalCreator/ScriptSources/raw/refs/heads/main/Ambuh.rbxm" --Url of entity model
...
local rebounds = math.random(6, 10) --Amount of rebounds the entity will do
