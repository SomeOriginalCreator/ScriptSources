...
spawner.changeSettings("https://github.com/SomeOriginalCreator/ScriptSources/raw/refs/heads/main/GlitchAmbush.rbxm", 1, true, true, math.random(10, 20), 1, "1840927187", 13, false, 1, function()
...
spawner.changeGuidingLight({"what did you die to this time?", "Ok.", "", "", "", "", "", "Thanks for stopping by."}, "Yellow")
spawner.spawn()
